...
SOURCEFILES_QUOTED_IF_SPACED=DriverPicTrainer/adc.c DriverPicTrainer/config.c DriverPicTrainer/idle.c DriverPicTrainer/pwm.c DriverPicTrainer/uart.c DriverPicTrainer/uart2.c btconfig.c main.c timers.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/DriverPicTrainer/adc.o ${OBJECTDIR}/DriverPicTrainer/config.o ${OBJECTDIR}/DriverPicTrainer/idle.o ${OBJECTDIR}/DriverPicTrainer/pwm.o ${OBJECTDIR}/DriverPicTrainer/uart.o ${OBJECTDIR}/DriverPicTrainer/uart2.o ${OBJECTDIR}/btconfig.o ${OBJECTDIR}/main.o ${OBJECTDIR}/timers.o
POSSIBLE_DEPFILES=${OBJECTDIR}/DriverPicTrainer/adc.o.d ${OBJECTDIR}/DriverPicTrainer/config.o.d ${OBJECTDIR}/DriverPicTrainer/idle.o.d ${OBJECTDIR}/DriverPicTrainer/pwm.o.d ${OBJECTDIR}/DriverPicTrainer/uart.o.d ${OBJECTDIR}/DriverPicTrainer/uart2.o.d ${OBJECTDIR}/btconfig.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/timers.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/DriverPicTrainer/adc.o ${OBJECTDIR}/DriverPicTrainer/config.o ${OBJECTDIR}/DriverPicTrainer/idle.o ${OBJECTDIR}/DriverPicTrainer/pwm.o ${OBJECTDIR}/DriverPicTrainer/uart.o ${OBJECTDIR}/DriverPicTrainer/uart2.o ${OBJECTDIR}/btconfig.o ${OBJECTDIR}/main.o ${OBJECTDIR}/timers.o

# Source Files
SOURCEFILES=DriverPicTrainer/adc.c DriverPicTrainer/config.c DriverPicTrainer/idle.c DriverPicTrainer/pwm.c DriverPicTrainer/uart.c DriverPicTrainer/uart2.c btconfig.c main.c timers.c
...
${OBJECTDIR}/DriverPicTrainer/adc.o: DriverPicTrainer/adc.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/adc.c  -o ${OBJECTDIR}/DriverPicTrainer/adc.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/adc.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/DriverPicTrainer/config.o: DriverPicTrainer/config.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/config.c  -o ${OBJECTDIR}/DriverPicTrainer/config.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/config.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/DriverPicTrainer/idle.o: DriverPicTrainer/idle.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/idle.c  -o ${OBJECTDIR}/DriverPicTrainer/idle.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/idle.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/DriverPicTrainer/pwm.o: DriverPicTrainer/pwm.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/pwm.c  -o ${OBJECTDIR}/DriverPicTrainer/pwm.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/pwm.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/DriverPicTrainer/uart.o: DriverPicTrainer/uart.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/uart.c  -o ${OBJECTDIR}/DriverPicTrainer/uart.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/uart.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/DriverPicTrainer/uart2.o: DriverPicTrainer/uart2.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  DriverPicTrainer/uart2.c  -o ${OBJECTDIR}/DriverPicTrainer/uart2.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/DriverPicTrainer/uart2.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
${OBJECTDIR}/btconfig.o: btconfig.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE)  btconfig.c  -o ${OBJECTDIR}/btconfig.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/btconfig.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off  
...
dist/${CND_CONF}/${IMAGE_TYPE}/BTdriver.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/BTdriver.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x800:0x81F -mreserve=data@0x820:0x821 -mreserve=data@0x822:0x823 -mreserve=data@0x824:0x825 -mreserve=data@0x826:0x84F   -Wl,,,--defsym=__MPLAB_BUILD=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml$(MP_EXTRA_LD_POST) 
